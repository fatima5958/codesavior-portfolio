    ...
    <>
      ...
      <div className="w-full flex">
        <p className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
          Here’s a selection of my most impactful work—spanning game development,
          backend systems, and data-driven dashboards. Each project reflects my
          passion for solving real problems through clean code and user-first design.</p>
      </div>
